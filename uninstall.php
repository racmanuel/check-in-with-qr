 ...
 * of control:
 *
 * - Check if the $_REQUEST['plugin'] content actually is check-in-with-qr/check-in-with-qr.php
 ...
 * @since 1.0.0
 */
function check_in_with_qr_uninstall() {

	if ( ! defined( 'WP_UNINSTALL_PLUGIN' )
		|| empty( $_REQUEST )
		|| ! isset( $_REQUEST['plugin'] )
		|| ! isset( $_REQUEST['action'] )
		|| 'check-in-with-qr/check-in-with-qr.php' !== $_REQUEST['plugin']
