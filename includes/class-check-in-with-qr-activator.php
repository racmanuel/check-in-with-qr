 ...
 */
class Check_In_With_Qr_Activator
{
     ...
     */
    private static $plugin = CHECK_IN_WITH_QR_BASE_NAME;
    ...
    {
        global $wpdb;
        global $check_in_out_db_version;
        ...
        add_option('check_in_out_db_version', $check_in_out_db_version);
    }
